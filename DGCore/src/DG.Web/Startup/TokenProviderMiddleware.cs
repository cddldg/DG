...
namespace DG.Web
{
    public class TokenProviderMiddleware
    {
        ...
        public TokenProviderMiddleware(RequestDelegate next,IOptions<TokenProviderOptions> options,/*IUserService _service,*/ IAuthenticationSchemeProvider schemes)
        {
            _next = next;
        ...
        {
            var isValidated = username == "admin" && password == "111111";// _service.Auth(username, password);
